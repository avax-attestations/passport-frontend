...
import { EAS_ADDRESS } from "@/lib/config";
import { Wallet, JsonRpcProvider, FallbackProvider, JsonRpcProvider } from 'ethers';
import { ATTESTATION_CONFIG } from '@/lib/config';
...
export async function getAttestedVolume(
  ...
  console.log('got total attested volume', totalVolume);
  return totalVolume;
}
