...
import { isYieldYakAirdrop, attestedYieldYakAirdrop} from "@/lib/yield-yak"
import { signYieldYakAirdrop} from '@/lib/signing/yield-yak-airdrop';
...
export async function POST(req: NextRequest) {
  ...
  if (await lock.acquire()) {
    try {
      ...
      const signedResponse = await signYieldYakAirdrop(walletAddress);
